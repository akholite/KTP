...
public class AStarState
{
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        Iterator iter = openWaypoints.entrySet().iterator();

        if (iter.hasNext()) {
            Map.Entry first = (Map.Entry)iter.next();
            minWaypoint = (Waypoint) first.getValue();
            min = minWaypoint.getTotalCost();
        }
        else {
            return null;
        }
        ...
        while (iter.hasNext()) {
            ...
            Waypoint wp = (Waypoint) element.getValue();
